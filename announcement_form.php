                ...
                <div class="form-card-body">
                    <form action="announcement_process.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            <!-- Judul -->
                            <div class="col-12">
                                <label class="form-label-admin">Judul Berita / Pengumuman <span style="color:#ef4444;">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="is_published" class="form-control-admin" style="<?php echo $is_published?'border-color:#bbf7d0;background:#f0fdf4;':''; ?>"
                            ...
                            <div class="col-12">
                                ...
                                <div class="img-preview-wrap mt-2">
                                    <img id="imgPreview" src="<?php echo htmlspecialchars($image); ?>" alt="Preview" style="max-height:180px;border-radius:8px;object-fit:cover;">
                                </div>
                                <?php else: ?>
                                <div class="img-preview-wrap mt-2" id="imgPreviewWrap" style="display:none;">
                                    <img id="imgPreview" src="" alt="Preview" style="max-height:180px;border-radius:8px;object-fit:cover;">
                                </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <!-- Isi -->
                            <div class="col-12">
                                <label class="form-label-admin">Isi Berita / Pengumuman <span style="color:#ef4444;">*</span></label>
