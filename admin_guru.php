                ...
                <div class="admin-card">
                    <div class="table-toolbar">
                        <form method="GET" class="d-flex align-items-center gap-2 flex-wrap w-100">
                            ...
                            <?php endif; ?>
                            <span style="margin-left:auto;font-size:.8rem;color:#94a3b8;"><?php echo $total; ?> data
                                ditemukan</span>
                        </form>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    <img src="<?php echo htmlspecialchars($r['photo']); ?>" class="tbl-avatar"
                                                        alt="">
                                                    <div>
                                            ...
                                            <td>
                                                <span
                                                    style="display:inline-flex;align-items:center;gap:.35rem;font-size:.8rem;background:#f1f5f9;color:#475569;padding:.3rem .75rem;border-radius:50px;font-weight:600;">
